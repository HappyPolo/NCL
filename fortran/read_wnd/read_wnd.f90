subroutine read_wnd(id,stat,lon,lat,h,wnd_input,yyyy,mm,dd)
    implicit none
	real :: lon(937152),lat(937152),h(937152),wnd(937152),wnd_input(4748,349)
	integer yy(937152),mm(937152),dd(937152),yyyy(937152)
	integer i,num,j,sta,ns,nt,n
	character(20) id(937152) ,date,stat(349)
	open(3001,file='/home/ys-ug/data/Station/wnd.csv')
	open(3002,file='/home/ys-ug/data/Station/wnd_date.csv')
	num=937152
	sta=0
	wnd_input=9999
!========================================================================
...
!========================================================================+
	...
	do ns = 1, sta
		nt=1
		do while (.true.)
			if (stat(ns) /= id(n)) exit
			wnd_input(nt,ns)=wnd(n)
			nt=nt+1
			n=n+1
		end do 
	end do  
